...
`7MMM.     ,MMF'      db      `7MM"""Mq.`7MMF'   `7MF'`7MM"""YMM     
  MMMb    dPMM       ;MM:       MM   `MM. MM       M    MM    `7     
  M YM   ,M MM      ,V^MM.      MM   ,M9  MM       M    MM   d       
  M  Mb  M' MM     ,M  `MM      MMmmdM9   MM       M    MM""MM       
  M  YM.P'  MM     AbmmmqMA     MM  YM.   MM       M    MM   Y       
  M  `YM'   MM    A'     VML    MM   `Mb. YM.     ,M    MM           
.JML. `'  .JMML..AMA.   .AMMA..JMML. .JMM. `bmmmmd"'  .JMML.       
